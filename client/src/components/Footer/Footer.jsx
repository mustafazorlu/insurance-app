...
const Footer = () => {
    return (
        <footer className="footer bg-white pt-20">
            <div className="cont">
                <div className="footer-wrapper flex justify-between border-b pb-10">
                    <div className="logo text-2xl font-bold font-outfit">
                        Yılmaz Sigorta
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-slate-500 flex flex-col gap-1">
                            <span className="footer-link">Kasko Sigortası</span>
                            <span className="footer-link">
                                Trafik Sigortası
                            </span>
                            <span className="footer-link">İMM Sigortası</span>
                            <span className="footer-link">Konut Sigortası</span>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-slate-500 flex flex-col gap-1">
                            ...
                            <span className="footer-link">SBM Teklif Al</span>
                        </div>
                    </div>
